...
void Bomb::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->explotar(); break;
        case 1: _t->detonar(); break;
        case 2: _t->animarExplosion(); break;
        default: ;
        }
        ...
        {
            using _t = void (Bomb::*)();
            if (_t _q_method = &Bomb::explotar; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
